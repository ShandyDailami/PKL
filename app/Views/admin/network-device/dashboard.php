  ...
  <div class="row">
    <div class="col-3 px-3 pt-4 position-fixed" style="top: 50px; overflow-y: auto;">
      <div class="d-flex flex-column gap-2">
        ...
        <button id="networkDevice" class="btn text-start btn-main-active border-0"><i
      ...
      <div class="card">
        <div class="card-body">
          <div class="mb-3 d-flex justify-content-between align-items-center">
            <p class="fw-bold">Perangkat Jaringan</p>
            <form action="" method="get" class="d-flex" role="search">
              <input class="form-control me-2" value="<?= esc($keyword ?? '') ?>" name="keyword" type="search"
                placeholder="Search" aria-label="Search">
              <button class="btn btn-sec" type="submit"><i class="bi bi-search"></i></button>
            </form>
            <div class="d-flex gap-1">
              <button id="perangkatPDF" class="btn btn-sm btn-sec"><i class="bi bi-printer-fill"></i> Cetak</button>
            </div>
          </div>
                ...
                <?php if (!empty($devices)): ?>
                  ...
                  <?php foreach ($devices as $index => $device): ?>
                    <tr>
                      ...
                      <td>
                        <button id="tampilLog" data-id="<?= esc($device['id']) ?>" class="btn btn-sm btn-primary">Lihat
                          log</button>
                      </td>
                    </tr>
