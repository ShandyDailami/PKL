  ...
  <div class="row">
    ...
    <div class="offset-3 col-9 bg-main py-3">
      <div class="card">
        <div class="card-body">
          <div class="mb-3 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-1">
              <p></p>
              <button id="tambahLogItem" data-id="<?= $inventaris_id ?>" class="btn btn-sm btn-success">Tambah</button>
              <button id="backFromLogItem" class="btn btn-sm btn-sec">Kembali</button>
            </div>
          </div>
                ...
                <?php if (!empty($logs)): ?>
                  <?php foreach ($logs as $log): ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= site_url('admin/dashboard/inventaris/logs/' . $log['inventaris_id'] . '/edit/' . $log['id']) ?>"
                          class="btn btn-sm btn-warning">
                          Edit
                        </a>
                        <button class="btn btn-sm btn-danger" data-bs-target="#deleteLogItem" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="deleteLogItem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="confirmDelLogItem">Hapus</button>
              </div>
            </div>
          </div>
        </div>
